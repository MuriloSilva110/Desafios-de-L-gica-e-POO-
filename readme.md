...
Este repositório é o meu "laboratório" de desenvolvimento. Aqui reúno diversos desafios de programação e exercícios práticos realizados durante a graduação em Análise e Desenvolvimento de Sistemas (Unisa). O objetivo é consolidar os fundamentos de Python, focando em autonomia e resolução de problemas sem o uso de geradores de código.
